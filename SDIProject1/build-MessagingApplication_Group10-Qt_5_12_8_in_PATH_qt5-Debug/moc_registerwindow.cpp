...
#include "../MessagingApplication_Group10/registerwindow.h"
...
QT_MOC_LITERAL(3, 28, 29) // "on_RegisterBackButton_clicked"

    },
    "RegisterWindow\0BackClicked\0\0"
    "on_RegisterBackButton_clicked"
};
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_RegisterBackButton_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterWindow::BackClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWindow::BackClicked()
{
