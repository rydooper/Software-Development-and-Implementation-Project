...
"\n"
"#RegisterWindow{background-color: qlineargradient(spread:pad, x1:0.512, y1:1, x2:0.503, y2:0.306727, stop:0.0696517 rgba(169, 169, 169, 255), stop:0.890547 rgba(255, 255, 255, 255));}\n"
"#stackedWidget{ background-color: rgba(1,1,1,0);}"));
        ...
        RegisterTitle->setGeometry(QRect(180, 19, 191, 41));
        QFont font;
        ...
        ForenameRegisterLabel->setGeometry(QRect(100, 80, 81, 21));
        QFont font1;
        font1.setFamily(QString::fromUtf8("AnjaliOldLipi"));
        ForenameRegisterLabel->setFont(font1);
        ForenameRegisterLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        ...
        SurnameRegisterLabe->setGeometry(QRect(110, 120, 67, 21));
        SurnameRegisterLabe->setFont(font1);
        SurnameRegisterLabe->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        ...
        PasswordRegisterLabel->setGeometry(QRect(106, 250, 71, 21));
        PasswordRegisterLabel->setFont(font1);
        PasswordRegisterLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        ...
        PasswordRegisterLabel_2->setGeometry(QRect(50, 290, 131, 21));
        PasswordRegisterLabel_2->setFont(font1);
        PasswordRegisterLabel_2->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        ...
        UsernameRegisterLabel->setGeometry(QRect(90, 210, 81, 21));
        UsernameRegisterLabel->setFont(font1);
        UsernameRegisterLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        ...
        EmailRegisterLabel->setGeometry(QRect(110, 160, 67, 21));
        EmailRegisterLabel->setFont(font1);
        EmailRegisterLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        ...
        RegisterButton->setGeometry(QRect(270, 330, 89, 31));
        QPalette palette;
        ...
        RegisterBackButton->setGeometry(QRect(20, 354, 89, 31));
        RegisterBackButton->setFont(font2);
